<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Authorize.aspx.cs" Inherits="CloudyBank.Web.Sites.Authorize" %>
...
<body>
    ...
    <div>
    <h1>OctoBank - authorization of external application</h1>
    <p>An extern application demands the authorization to obtain data from OctoBank</p>
    <asp:MultiView runat="server" ActiveViewIndex="0" ID="multiView">
        <asp:View ID="View1" runat="server">
            ...
            <table>
                <tr>
                    <td>Application demanding the acces: </td>
                    <td><asp:Label ID="consumerLabel" Font-Bold="true" runat="server" Text="[consumer]" /></td>
                </tr>
                <tr>
                    <td>The resource demanded by the application: </td>
                    <td><asp:Label ID="desiredAccessLabel" Font-Bold="true" runat="server" Text="[protected resource]" />.</td>
                </tr>
                <tr>
                    <td></td>
                    <td>By clicking on authorize, you will grant the application the rights to access this resources. Later you can manage remove this right for the application 
                        in the settings tab of OctoBank's interface.
                        </td>
                </tr>
                <tr>
                    <td></td>
                    <td><asp:Button ID="btnAuthorize" runat="server" OnClick="Authtorize_Click" Text="Authorize"/></td>
                </tr>
            </table>
